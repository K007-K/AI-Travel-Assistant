...
import { User, Mail, Lock, ArrowRight, Loader, Plane } from 'lucide-react';
...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen w-full relative flex items-center justify-center p-4 selection:bg-blue-200/30 selection:text-white overflow-hidden py-12">
            ...
            {/* Logo - Top Left */}
            <Link to="/" className="fixed top-8 left-8 flex items-center gap-2 group z-20 hidden md:flex">
            ...
            <div className="relative z-10 w-full max-w-[420px] mx-auto mt-4 md:mt-12">
                <motion.div 
                ...
                >
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-display font-black text-white mb-2 tracking-tight drop-shadow-sm">Join Roameo.</h1>
                        <p className="text-white/70 font-medium text-sm">Create your free account to unlock sentient travel orchestration.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-1.5">
                            <label className="block text-xs font-bold text-white/80 ml-1 uppercase tracking-wider">Full Name</label>
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-bold text-white/80 ml-1 uppercase tracking-wider">Password</label>
                            <div className="relative group">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 group-focus-within:text-white transition-colors">
                    ...
                    <div className="text-center text-sm font-medium text-white/60 pt-6 mt-6 border-t border-white/10">
                        ...
                        <Link to="/login" className="font-bold text-white hover:underline underline-offset-4 transition-all">
                            Sign in instead
                        </Link>
                    </div>
                </motion.div>
