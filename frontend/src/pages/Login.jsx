            ...
            <div className="w-full max-w-md">
                <div className="bg-white dark:bg-[#111111] rounded-3xl shadow-xl dark:shadow-2xl dark:shadow-black/50 overflow-hidden border border-slate-200 dark:border-white/[0.08] p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1">
                                ...
                                <Link to="/forgot-password" className="text-xs font-semibold text-primary-600 dark:text-blue-400 hover:text-primary-500">Forgot password?</Link>
                            </div>
                            <div className="relative">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500">
                    ...
                    <div className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
                        ...
                        <Link to="/signup" className="font-semibold text-primary-600 dark:text-blue-400 hover:text-primary-500">
                            Create an account
                        </Link>
                    </div>
                </div>
