                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex-1">
                            <select
                                ...
                                className="w-full px-4 py-3 bg-slate-50 dark:bg-[#0a0a0a] dark:bg-slate-700 border border-slate-200 dark:border-white/[0.06] dark:border-slate-600 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-200 focus:ring-2 focus:ring-indigo-500 outline-none appearance-none cursor-pointer"
                            >
                                {LANGUAGES.map(lang => (
                            ...
                            <AnimatePresence mode="wait">
                                {loading ? (
                                    ...
                                    <motion.p
                                        ...
                                        className="text-lg text-slate-800 dark:text-slate-200 dark:text-slate-100 leading-relaxed"
                                    >
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-slate-300 dark:text-slate-600 dark:text-slate-400 mt-1">⌘ + Enter to translate</p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                        </div>
                    ...
                    {culturalContext && (
                        ...
                        >
                            <div className="flex items-start gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-slate-800 dark:text-slate-200 dark:text-slate-200 mb-1">Cultural Context</h3>
                            ...
                            {culturalContext.tips && culturalContext.tips.length > 0 && (
                                <div className="ml-11 space-y-2">
                                    {culturalContext.tips.map((tip, i) => (
                                        <div key={i} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-400 dark:text-slate-400">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {TRAVEL_PHRASES.map((phrase, i) => (
                            <button
                                ...
                                className="px-3 py-2 text-sm bg-slate-50 dark:bg-[#0a0a0a] dark:bg-slate-700 text-slate-600 dark:text-slate-400 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-700 dark:hover:text-indigo-400 rounded-lg transition-colors border border-slate-200 dark:border-white/[0.06] dark:border-slate-600 hover:border-indigo-200 dark:hover:border-indigo-700"
                            >
                                {phrase.text}
                            </button>
                        ))}
                        ...
                        <div className="space-y-3">
                            {history.map((item, i) => (
                                <button
                                    ...
                                    className="w-full text-left p-3 bg-slate-50 dark:bg-[#0a0a0a] dark:bg-slate-700/50 rounded-xl hover:bg-slate-100 dark:bg-white/[0.05] dark:hover:bg-slate-700 transition-colors group"
                                >
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-slate-400 dark:text-slate-300 truncate">{item.input}</p>
